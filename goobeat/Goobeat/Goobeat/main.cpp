...
HINSTANCE g_hInst;
LPCWSTR lpszClass=L"Goobeat+ Project v.1.2.2";
...
//	_CrtSetDbgFlag( _CRTDBG_ALLOC_MEM_DF | _CRTDBG_LEAK_CHECK_DF );
	...
	NoteMake notemake;
//	notemake.MakeNote(tempvector, L"Music",L"..\\Note",1.05, 0.25);
	notemake.MakeNote(tempvector, L"Music",L"..\\Note",0.7, 0.5);
//	notemake.MakeNote(tempvector, L"Music",L"..\\Note",1.37, 0.15);
